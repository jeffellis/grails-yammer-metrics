...
class GrailsAdminServlet extends HttpServlet {
    ...
    GrailsAdminServlet() {
        this(new GrailsHealthCheckServlet(), new MetricsServlet(), new PingServlet(),
                new ThreadDumpServlet(), DEFAULT_HEALTHCHECK_URI, DEFAULT_METRICS_URI,
                DEFAULT_PING_URI, DEFAULT_THREADS_URI);
    }

    public GrailsAdminServlet(HealthCheckServlet healthCheckServlet,
